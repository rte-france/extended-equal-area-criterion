...
class TableDescription:
    ...
    :ivar names: names.
    :ivar first_data_row_nb: first data row nb.
    :ivar row_format: row format.
    :ivar object_type: object type.
    :ivar data_occurrences: data occurrences.
    """

    def __init__(self,
                 names: List[str],
                 first_data_row_nb: int,
                 row_format: Dict[str, Tuple],
                 object_type: str,
                 data_occurrences: Tuple = (1, 0),
        ...
        :param data_occurrences: Tuple describing if multiple occurrences of the data may appear in the row.
        ...
        # self._load_flow_data = load_flow_data
        self.data_occurrences = data_occurrences
    ...
    @staticmethod
    def _add_field_data(load_flow_data_content: Dict[str, str], field_name: str, field_data: str):
        """
    ...
    def parse_row(self, row: str) -> List[Dict]:
        """
        Parse row.
        ...
        (nb_occurrences, offset) = self.data_occurrences
        for i in range(0, nb_occurrences):
            ...
            if not load_flow_data_content:
                ...
                load_flow_data_objects.append(load_flow_data_content)
