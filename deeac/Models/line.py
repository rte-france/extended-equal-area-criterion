...
class Line:
    ...
    :ivar base_impedance: base impedance.
    :ivar resistance: resistance.
    :ivar reactance: reactance.
    :ivar shunt_conductance: shunt conductance.
    :ivar shunt_susceptance: shunt susceptance.
    ...
    def base_impedance(self, base_impedance: float) -> None:
        """
        Base impedance.
        ...
        self._base_impedance = base_impedance
        self._resistance_pu *= old_base_impedance / base_impedance
        self._reactance_pu *= old_base_impedance / base_impedance
        self._shunt_conductance_pu *= base_impedance / old_base_impedance
        self._shunt_conductance_pu *= base_impedance / old_base_impedance
