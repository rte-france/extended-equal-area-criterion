"""
Module for omib_calculator.

:module: omib_calculator
"""
...
from deeac.Simulations.OMIB.omib import OMIBSwingState


class OMIBTrajectoryPoint:
    """
    ...
    """
    def __init__(self, network_state: NetworkState, time: float, angle: float, angular_speed: float):
        """
...
class OMIBTrajectoryAngle:
    ...
    :param network_state: Network state to consider on the trajectory from this angle (i.e. in the future).
    :param angle: OMIB angle (rad) on the trajectory.
    """
    def __init__(self, network_state: NetworkState, angle: float):
        """
        Initialize the object.
...
class OMIBRotorAngleTrajectoryCalculator(ABC):
    """
    Omibrotorangletrajectorycalculator.
    ...
    :ivar _omib: omib.
    :ivar _transition_angle_shift: transition angle shift.
    """
